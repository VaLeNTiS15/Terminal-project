...
class FavoriteFragment : Fragment() {
    ...
    //функція виведення повідомлення про те, що користувач не вподобав жодного слова
    ...
    override fun onCreateView(
        ...
        //Вставляємо значення змінних у відповідні графічні компоненти,
        // створення recyclerView,
        // звернення до FavoriteViewModel та FavoriteAdapter
