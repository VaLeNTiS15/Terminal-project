...
class DefinitionActivity : AppCompatActivity() {
    ...
    //передаємо DefinitionViewModel в актівіті
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Беремо дані про слово, яке шукаємо
        val wordDao = WordDatabase.getDatabase(this).wordDao()
        val toast = Toast(this).apply {
            duration = Toast.LENGTH_SHORT
        }

        //За допомогою бібліотеки Glide додаємо зображення для фону
        ...
        //Надаємо змінним відповідні графічні компоненти
        ...
        //обробка подій зміни іконки при натисканні кнопки favorite
        if (wordString != null) {
            ...
            //обробка подій при натисканні кнопки favorite: додавання/видалення слова зі збережених
            //виведення відповідних підказок toast
            ...
            //виклик convertStringIntoWord
            val word = Utils.convertStringIntoWord(wordString)

            //виведення даних у відповідні графічні компоненти
    ...
    //функція для зміни зображення іконки кнопки favorite
    ...
    //функція для генерації hex коду зображення для фону актівіті
